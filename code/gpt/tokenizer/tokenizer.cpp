...
int main()
{
    ...
    TWordStats counts;
    LoadRandomDocsets(&counts, rng, "D:/text/cultura_y", 20, 7059);
    LoadRandomDocsets(&counts, rng, "D:/text/librusec", 10, 440);
    LoadRandomDocsets(&counts, rng, "D:/text/open_web_text", 20, 802);
